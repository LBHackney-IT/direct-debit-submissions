using DirectDebitSubmissions.Tests.E2ETests.Fixtures;
using DirectDebitSubmissions.Tests.E2ETests.Steps;
using Hackney.Core.Testing.DynamoDb;
using System;
using TestStack.BDDfy;
using Xunit;

namespace DirectDebitSubmissions.Tests.E2ETests.Stories
{
    [Story(
