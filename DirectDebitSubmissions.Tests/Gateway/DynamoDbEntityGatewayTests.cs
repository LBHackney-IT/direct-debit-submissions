...
using DirectDebitSubmissions.Factories;
using DirectDebitSubmissions.Gateway;
using DirectDebitSubmissions.Infrastructure;
...
namespace DirectDebitSubmissions.Tests.Gateway
{
