# DirectDebitSubmissions.Tests

This is the test project for the DirectDebitSubmissions application.
...
See the [BaseSteps class](/DirectDebitSubmissions.Tests/E2ETests/Steps/BaseSteps.cs) for more details.
